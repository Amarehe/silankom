...
class AktivitasTerbaruKaryawan extends Widget
{
    ...
    /**
     * Mengambil 10 aktivitas terbaru khusus untuk Karyawan yang sedang login.
     *
    ...
    public function getAktivitas(): Collection
    {
        ...
        PeminjamanModel::query()
            ->with('reqPinjam.user')
            ->whereHas('reqPinjam', function ($q) use ($userId) {
